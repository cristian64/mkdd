...
public:
    ...
    void init(MessageID messageID);  // 0x8016b138
    void draw();                     // 0x8016b65c
    void calc_bck();
    void calc_texChange();
    void calc(int param);  // 0x8016b6dc
...
private:
    ...
    J2DTextBox *mTextBoxYes;             // 0x24
    J2DTextBox *mTextBoxNo;              // 0x28
    J2DTextBox *mTextBoxNum;             // 0x2c
    J2DPicture *mPictureYes;             // 0x30
    J2DPicture *mPictureNo;              // 0x34
    J2DPicture *mPictureNintendo;        // 0x38
    J2DPicture *mPictureDolby;           // 0x3c
    J2DAnmTransform *mTransform;         // 0x40
    J2DAnmColor *mColors[4];             // 0x44
    J2DAnmTextureSRTKey *mSTRKey;        // 0x54
    s32 mTransformFrame;                 // 0x58
    s32 mSTRKeyFrame;                    // 0x5c
    s32 mFrame;                          // 0x60
    MessageID mMsgId;                    // 0x64
    int mState;                          // 0x68
    int mOption;                         // 0x6c
    s32 mColorsFrame;                    // 0x70
    J2DTextBox::TFontSize mFontSize;     // 0x74
    J2DTextBox::TFontSize mFontSizeYes;  // 0x7c
    J2DTextBox::TFontSize mFontSizeNo;   // 0x84
    u8 _8c[8];                           // 0x8c
};  // Size: 0x94
